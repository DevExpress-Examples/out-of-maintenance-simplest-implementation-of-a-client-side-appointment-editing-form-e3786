...
<%@ Register Assembly="DevExpress.Web.v10.1, Version=10.1.12.0, Culture=neutral, PublicKeyToken=b88d1754d700e49a" Namespace="DevExpress.Web.ASPxPopupControl" TagPrefix="dxpc" %>
...
<%@ Register Assembly="DevExpress.XtraScheduler.v10.1.Core, Version=10.1.12.0, Culture=neutral, PublicKeyToken=b88d1754d700e49a" Namespace="DevExpress.XtraScheduler" TagPrefix="dxschsc" %>
...
<body>
    ...
    <div>
        ...
        <dxpc:ASPxPopupControl ID="ASPxPopupControl1" runat="server" ClientInstanceName="myFormPopup"
            ...
            EnableAnimation="false" Width="0px" Height="0px" Modal="true" CloseAction="CloseButton">
            <ContentCollection>
