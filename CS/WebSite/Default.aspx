...
<%@ Register Assembly="DevExpress.XtraScheduler.v15.2.Core, Version=15.2.16.0, Culture=neutral, PublicKeyToken=b88d1754d700e49a" Namespace="DevExpress.XtraScheduler" TagPrefix="dxschsc" %>
...
<head id="Head1" runat="server">
    <script type="text/javascript">
        function OnMenuItemClick(s, e) {
                ...
                else if (e.item.name  == "NewAppointment") {
                    NewAppointment(scheduler);
                }
                else if (e.item.name  == "NewAllDayEvent") {
