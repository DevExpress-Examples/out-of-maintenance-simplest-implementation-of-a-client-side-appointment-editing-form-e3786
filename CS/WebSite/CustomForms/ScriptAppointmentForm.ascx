...
<%@ Register Assembly="DevExpress.Web.ASPxScheduler.v10.1, Version=10.1.12.0, Culture=neutral, PublicKeyToken=b88d1754d700e49a" Namespace="DevExpress.Web.ASPxScheduler.Controls" TagPrefix="dxsc" %>
...
<script id="dxss_ASPxSchedulerClientAppoinmentForm" type="text/javascript">
    ASPxClientAppointmentForm = _aspxCreateClass(ASPxClientFormBase, {
        Initialize: function() {
            this.controls.btnOk.Click.AddHandler(_aspxCreateDelegate(this.OnBtnOkClick, this));
            this.controls.btnCancel.Click.AddHandler(_aspxCreateDelegate(this.OnBtnCancelClick, this));
