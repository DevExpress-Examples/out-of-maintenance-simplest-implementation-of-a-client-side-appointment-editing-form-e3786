...
Public Class CustomAppointmentFormController
	...
	Public Property Price() As Nullable(Of Double)
		Get
			Return CType(EditedAppointmentCopy.CustomFields(PriceFieldName), Nullable(Of Double))
		End Get
	...
	Private Property SourcePrice() As Nullable(Of Double)
		Get
			Return CType(SourceAppointment.CustomFields(PriceFieldName), Nullable(Of Double))
		End Get
		Set(ByVal value As Nullable(Of Double))
